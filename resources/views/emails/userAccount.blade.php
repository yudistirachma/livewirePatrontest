...
<head>
    ...
    <title>Patron Media Inspirasi</title>
                            ...
                            <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                                ...
                                <tr>
                                    <td align="center" height="70" style="height:70px;">
                                        <a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="100" border="0" style="display: block; width: 100px;" src="https://i0.wp.com/patron.id/wp-content/uploads/2019/12/PATRON-PNG-1-e1561405219828.png" alt="" /></a>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;"
                            ...
                            <div style="line-height: 35px">
                                ...
                                Welcome to the future of <span style="color: red;">media inspiration</span>
                            ...
                            <table border="0" width="590" align="center" cellpadding="0" cellspacing="0" class="container590">
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <p style="line-height: 24px;margin-bottom:15px;">
                                            Congratulations, you are now part of the <span style="color: red;">Patron Media Inspirasi</span> family with your position as a <span style="font-weight: bold;">{{$position}}</span> (✿◠‿◠) 
                                        </p>
                                        ...
                                        <p style="line-height: 24px; margin-bottom:20px;">
                                            You can login to your account using email and password with click to the button link below.
                                        </p>
                                            ...
                                            <tr>
                                                <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">
                                                    ...
                                                    <div style="line-height: 22px;">
                                                        <a href="http://127.0.0.1:8000/" target="_blank" style="color: #ffffff; text-decoration: none;">login to your account</a>
                                                    </div>
                                                </td>
                                            </tr>
                                    ...
                                    <td>
                                        <table border="0" width="300" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"
                                            ...
                                            <tr>
                                                <!-- logo -->
                                                <td align="left">
                                                    <a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="80" border="0" style="display: block; width: 80px;" src="https://i0.wp.com/patron.id/wp-content/uploads/2019/12/PATRON-PNG-1-e1561405219828.png?w=466&ssl=1" alt="" /></a>
                                                </td>
                                            </tr>
                                                ...
                                                <td>
                                                    <table border="0" align="right" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                            <td>
                                                                <a href="https://www.instagram.com/patroninspirasi/" style="display: block; border-style: none !important; border: 0 !important;"><img width="24" border="0" style="display: block;" src="http://i.imgur.com/RBRORq1.png" alt=""></a>
                                                            </td>
                                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                            <!-- <td>
