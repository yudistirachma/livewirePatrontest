                                ...
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <p style="line-height: 24px;margin-bottom:15px;">
                                            {{ $redakturName }} ({{$redakturId}}, {{$redakturEmail}}) request for deleteing content title <span style="font-weight: bold">{{ $titleContent }} ({{$idContent}})</span>  in {{ $segment }} segment group
                                        </p>
