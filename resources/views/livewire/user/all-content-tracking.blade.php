    ...
    <div class=" mb-3 d-flex justify-content-center">
        <form class=" navbar-search " wire:submit.prevent="updatingSearch" style="width: 50%;">
            <div class="input-group input-group-sm">
                <input type="text" class="form-control border-0 small bg-white" placeholder="search by title or id content..." aria-label="Search" aria-describedby="basic-addon2" wire:model.defer="search">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <small class="mx-1 font-weight-bold text-capitalize">{{ Str::limit($content->user->name, 15) }}</small>
                        &middot;<small class="mx-1">{{ $content->deadline ? 'Deadline '. $content->deadline->format('d, M Y') : 'Not With Deadline' }}</small>
                        &middot;<small class="mx-1 text-capitalize">(Red) {{ $content->name }}</small>
                        &middot;<small class="mx-1 text-capitalize">{{ $content->segment }}</small>
                    </div>
                </div>
