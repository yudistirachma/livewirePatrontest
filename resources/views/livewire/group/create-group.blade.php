            ...
            <div class="form-group">
                ...
                <div>
                    @if (isset($redakturAdd))
                        <img style="height: 30px;width :30px;" src="{{ $redakturAdd['imgprofile'] != null ? asset('storage/'. $redakturAdd['imgprofile']) : asset('tamplate/img/undraw_profile.svg') }}" alt="" class="img-profile rounded-circle">
